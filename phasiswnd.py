...
PHASIS_EMPTY       = u"—"
PHASIS_EMPTY_TIME  = u"— (±%d days)" % PHASIS_WINDOW_DAYS

def _fmt_day_offset(n):
    # n: int (dt - refdate).days
    sfx  = u" day" if abs(n) == 1 else u" days"
...
class PhasisWnd(commonwnd.CommonWnd):
    ...
    def drawBkg(self):
        ...
        heads = (u"Planet", u"Phasis", u"Time (Days)")
