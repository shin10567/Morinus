...
# Roberto change  V 7.3.0 + V 8.0.1		
		...
		self.ID_Arabians, self.ID_Strip, self.ID_PlanetaryHours, self.ID_ExactTransits, self.ID_Profections, self.ID_CustomerSpeculum, self.ID_Firdaria, self.ID_Dodecatemoria, self.ID_AngleAtBirth, self.ID_PrimaryDirs) = range(111,136)
...
# Roberto change v 8.0.1
		self.mtable.Append(self.ID_Dodecatemoria, mtexts.menutxts['TMDodecatemoria'], mtexts.menutxts['TMDodecatemoriaDoc'])
# ###################################
		self.mtable.Append(self.ID_AngleAtBirth, 
							mtexts.menutxts['TMAngleAtBirth'], 
		...
		self.mcharts.Append(self.ID_Elections, u"Elections\tShift+Ctrl+F9", u"Shows Election-chart")
...
# ###########################################		
		...
		self.SetIcon(wx.Icon(_res_path('Morinus.ico'), wx.BITMAP_TYPE_ICO))
...
# ###################################      
	...
	def onAngleAtBirth(self, event):
		...
		if self.horoscope is None:
			wx.MessageBox(u"차트가 없습니다.", u"Angle at birth")
			return
