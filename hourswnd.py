...
class HoursWnd(commonwnd.CommonWnd):
    ...
    def drawBkg(self):
        ...
        txt = u'Time of Birth: ' + str(hh)+':'+str(mm).zfill(2)+':'+str(ss).zfill(2)
        ...
        if self.chart.time.ph != None:
            ...
            if self.chart.time.ph.daytime:
                txt1 = u'Sun Rise: ' + str(rh)+':'+str(rm).zfill(2)+':'+str(rs).zfill(2)
                txt2 = u'Sun Set: '  + str(sh)+':'+str(sm).zfill(2)+':'+str(ss).zfill(2)
            else:
                txt2 = u'Sun Rise: ' + str(rh)+':'+str(rm).zfill(2)+':'+str(rs).zfill(2)
                txt1 = u'Sun Set: '  + str(sh)+':'+str(sm).zfill(2)+':'+str(ss).zfill(2)
